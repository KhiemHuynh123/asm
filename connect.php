...
class Connect{
    ...
    {
        $this->server = "pxukqohrckdfo4ty.cbetxkdyhwsb.us-east-1.rds.amazonaws.com";
        $this->user = "olwlvdz64dni60zq";
        $this->password = "zbosuyinf6fcud1i";
        $this->dbName ="r5cgm7c8i0edg497";
    }
